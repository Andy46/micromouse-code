...
Platform PlatformFactory::CreatePlatform()
{
	...
	// Devices
	auto tof_expander = std::make_shared<EXTRA::PCF8574>(i2c1, GPIOEXPANDER_TOF_ADDRESS);
	...
	auto ledsw_expander = std::make_shared<EXTRA::PCF8574>(i2c1, GPIOEXPANDER_SWLED_ADDRESS);
