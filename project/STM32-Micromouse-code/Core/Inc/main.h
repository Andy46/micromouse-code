...
#define TOF_1_XSHUT_Pin GPIO_PIN_13
#define TOF_1_XSHUT_GPIO_Port GPIOB
#define TOF_2_XSHUT_Pin GPIO_PIN_14
#define TOF_2_XSHUT_GPIO_Port GPIOB
#define TOF_3_XSHUT_Pin GPIO_PIN_15
#define TOF_3_XSHUT_GPIO_Port GPIOB
#define TOF_4_XSHUT_Pin GPIO_PIN_8
#define TOF_4_XSHUT_GPIO_Port GPIOA
#define GY91_CS_Pin GPIO_PIN_9
#define GY91_CS_GPIO_Port GPIOA
